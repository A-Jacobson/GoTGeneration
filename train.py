...
# training settings
nb_epoch = 1	        #Number of iterations before we save our model
batch_size = 256		#Number of training examples pushed to the GPU per batch.
...
history = model.fit(X, y, batch_size=batch_size, nb_epoch=nb_epoch, verbose=1, callbacks=[checkpointer, earlystop])
